...
@Composable
fun AiringToday(navController: NavController, viewModel: HomeViewModel) {
    ...
    Column(
        ...
        Row(
            ...
            Text(
                stringResource(R.string.txt_airing_today),
                color = Neutral50,
        ...
        LazyRow(
            ...
            if (airingTodayShowsList.isEmpty() || isLoading) {
                items(2) {
                    EmptyStateCard(
                        Modifier
                            .width(150.dp)
